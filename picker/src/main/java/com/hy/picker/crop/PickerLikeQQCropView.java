 ...
 */
public class PickerLikeQQCropView extends View {
...
//    private Region touchRegion;//(暂时没用)
    ...
    public PickerLikeQQCropView setRadius(float radius) {
        this.radius = radius;
        post(() -> {
            refreshPath();
            invalidate();
    ...
    public PickerLikeQQCropView setMaskColor(@ColorInt int maskColor) {
    ...
    public PickerLikeQQCropView setBgColor(int bgColor) {
    ...
    public PickerLikeQQCropView setBorderColor(@ColorInt int borderColor) {
    ...
    public PickerLikeQQCropView setMaxScale(float maxScale) {
        if (maxScale < 1) {
            maxScale = 1;
        }
    ...
    public PickerLikeQQCropView setDoubleClickScale(float doubleClickScale) {
    ...
    public PickerLikeQQCropView(Context context) {
        super(context);
        initGesture();
        initAttr(null);
    }
    ...
    public PickerLikeQQCropView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initGesture();
        initAttr(attrs);
    }

    public PickerLikeQQCropView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

//        Paint showBitmapPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
...
//        paint.setStrokeWidth(2);
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.PickerLikeQQCropView);
        maskColor = typedArray.getColor(R.styleable.PickerLikeQQCropView_pickerMaskColor, Color.parseColor("#60000000"));
        bgColor = typedArray.getColor(R.styleable.PickerLikeQQCropView_pickerBgColor, Color.WHITE);
        borderColor = typedArray.getColor(R.styleable.PickerLikeQQCropView_pickerBorderColor, ContextCompat.getColor(getContext(), android.R.color.white));
        radius = typedArray.getDimension(R.styleable.PickerLikeQQCropView_pickerRadius, -1);

        maxScale = typedArray.getFloat(R.styleable.PickerLikeQQCropView_pickerMaxScale, 3f);
        doubleClickScale = typedArray.getFloat(R.styleable.PickerLikeQQCropView_pickerDoubleClickScale, 1.8f);
...
//                    circleRectFMatrix.mapRect(circleRectF);
                ...
                //移动图片
                if (canMoveBitmap && !canZoomCircle) {
                    //从左往右滑动图片(防止图片滑出裁剪框外)
                    if (distanceX < 0) {
...
//                                Log(initScale+"==="+initScale);
    ...
    /*******************************************************************************************************/
    public PickerLikeQQCropView setBitmap(int resId, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(getContext(), resId, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmap(String pathName, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(pathName, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmap(byte[] data, int offset, int length, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(data, offset, length, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmap(FileDescriptor fd, Rect outPadding, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(fd, outPadding, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmap(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(res, value, is, pad, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmap(InputStream is, Rect outPadding, int reqWidth, int reqHeight) {
    ...
    /*******************************************************************************************************/
    public PickerLikeQQCropView setBitmapForHeight(int resId, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(getContext(), resId, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForHeight(String pathName, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(pathName, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForHeight(byte[] data, int offset, int length, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(data, offset, length, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForHeight(FileDescriptor fd, Rect outPadding, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(fd, outPadding, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForHeight(Resources res, TypedValue value, InputStream is, Rect pad, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(res, value, is, pad, reqHeight);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForHeight(InputStream is, Rect outPadding, int reqHeight) {
    ...
    /*******************************************************************************************************/
    public PickerLikeQQCropView setBitmapForWidth(int resId, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(getContext(), resId, reqWidth);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForWidth(String pathName, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(pathName, reqWidth);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForWidth(byte[] data, int offset, int length, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(data, offset, length, reqWidth);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForWidth(FileDescriptor fd, Rect outPadding, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(fd, outPadding, reqWidth);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForWidth(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(res, value, is, pad, reqWidth);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForWidth(InputStream is, Rect outPadding, int reqWidth) {
    ...
    /*******************************************************************************************************/
    public PickerLikeQQCropView setBitmapForScale(int resId, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(getContext(), resId, scaleSize);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForScale(String pathName, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(pathName, scaleSize);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForScale(byte[] data, int offset, int length, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(data, offset, length, scaleSize);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForScale(FileDescriptor fd, Rect outPadding, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(fd, outPadding, scaleSize);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForScale(Resources res, TypedValue value, InputStream is, Rect pad, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(res, value, is, pad, scaleSize);
        resetBitmap();
        return this;
    }

    public PickerLikeQQCropView setBitmapForScale(InputStream is, Rect outPadding, int scaleSize) {
